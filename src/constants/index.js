...
export const myProjects = [
    ...
    {
        title: 'ClearMind - Explainable Hybrid Intelligence System for Panic Attack Detection and Severity Mapping',
        desc: 'ClearMind is a diagnostic framework for high-precision panic attack detection and severity classification. By integrating a Hybrid ANN-RF architecture, the system bridges the gap between complex physiological data and clinical insights through Explainable AI (XAI).',
        subdesc:
